...
public class ExploreDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<String> images = Stash.getArrayList("images", String.class);
        for(int i=0; i<images.size(); i++) {
            Log.d("dataaaa", images.get(i));
        }title.setText(itemHeader);
        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.listView);
        GridLayoutManager gridLayoutManager = new GridLayoutManager(getApplicationContext(), 1);
        recyclerView.setLayoutManager(gridLayoutManager);
        exploreAdapter = new ExploreAdapter(this, images, itemName, itemLatitudes, itemLongitudes, itemHeader);
    ...
    /*public void login(View view) {
        startActivity(new Intent(ExploreDetailsActivity.this, LoginActivity.class));
