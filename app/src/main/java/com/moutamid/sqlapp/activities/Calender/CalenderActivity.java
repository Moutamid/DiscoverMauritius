...
//                    startActivity(new Intent(CalenderActivity.this, MainActivity.class));
    ...
    public void explore(View view) {
        startActivity(new Intent(CalenderActivity.this, ExploreActivity.class));
    }

    public void my_trips(View view) {
        startActivity(new Intent(CalenderActivity.this, MyTripsActivity.class));
    }

    public void iternties(View view) {
        startActivity(new Intent(CalenderActivity.this, ItinerariesActivity.class));

    }

    public void organier(View view) {
        startActivity(new Intent(CalenderActivity.this, OrganizerActivity.class));
    }

    public void contact_us(View view) {
        startActivity(new Intent(CalenderActivity.this, ContactUsActivity.class));
    }


    public void tips(View view) {
        startActivity(new Intent(CalenderActivity.this, TravelTipsActivity.class));

    }

    public void about(View view) {
        startActivity(new Intent(CalenderActivity.this, AppInfoActivity.class));

    }

    /*public void login(View view) {
        startActivity(new Intent(CalenderActivity.this, LoginActivity.class));
    }*/
